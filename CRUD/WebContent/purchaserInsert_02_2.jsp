...
<jsp:useBean id="purchaser" class="com.jsplec.base.purchaser" scope="session" />
    ...
    <jsp:setProperty name="purchaser" property="userid" value="<%=str_userid %>" />
	<jsp:setProperty name="purchaser" property="name" value="<%=str_name %>" />
	<jsp:setProperty name="purchaser" property="tel" value="<%=str_tel %>" />
	<jsp:setProperty name="purchaser" property="address" value="<%=str_address %>" />
    
    
   	<jsp:forward page="purchaserInsert_03_2.jsp"/>
