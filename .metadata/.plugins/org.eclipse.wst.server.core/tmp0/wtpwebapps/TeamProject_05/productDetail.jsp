...
<body>
	<form action="search.bill"> 
		...
		<div class="search">
			<input type="text" class="searchbox" placeholder ="상품명, 제품명, 지역명 입력" name="search">
			...
			<h2>${pdDetail.title}</h2>
				<div class="dropdown">
				  ...
				  <div id="myDropdown" class="dropdown-content">
				    <a href="userinfoDetail.bill?nickname=${pdDetail.nickname}" onclick="window.open(this.href,'${pdDetail.nickname}의 정보','width=200, height=200'); return false;">사용자 정보</a>
				    <a href="messageSend.bill?nickname=${pdDetail.nickname}" onclick="window.open(this.href,'${pdDetail.nickname}에게 쪽지 보내기','width=850, height=600'); return false;">쪽지 보내기</a>
				  </div>
				</div>
		</div>
		<div class="details">
		...
		<div class="detailInfo">
			...
			<div class="borrow">
				...
				<div class="date">
					...
					<div class="sdatekeyin"><input type="text" name="syy" placeholder="yy" size="3">년
										<input type="text" name="smm" placeholder="mm" size="3">월
										<input type="text" name="sdd" placeholder="dd" size="3">일
					</div>
					<div class="endDate">끝</div>
					<div class="edatekeyin"><input type="text" name="eyy" placeholder="yy" size="3">년
										<input type="text" name="emm" placeholder="mm" size="3">월
										<input type="text" name="edd" placeholder="dd" size="3">일
					</div>
				</div>
					<INPUT type="hidden" name="brprdseq" value="<%=request.getParameter("prdseq")%>">
					<INPUT type="hidden" name="brmynick" value="수키">
				<div class="brwBtn">
	...
	<div class="comment">
			...
			<div class="commentList">
				<c:forEach items="${cmtDetail }" var="cmt">
					<div class="commentTable">
						...
						<div class="cmtRev" >
							<c:if test="${cmt.userCheck eq 1}"><input type="button" class="cmtBtn" value="수정/삭제" onclick="window.open('commentCheck.bill?cmtseq=${cmt.cmtseq}','팝업이름','width=500,height=500');" ></c:if>
							<!-- !!!!!!!!!!!!!!!!!!10 대신에 나의 userseq 받아오게!!!!!!!!!! -->
						</div>
					</div>
				</c:forEach>
			</div>
			...
			<div class="commentAdd">
				<form name="cmtform" action="" method="post" >
					...
					<INPUT type="hidden" name="myseq" value=10> <!-- !!!!!!!!!!!!!!!!!!10 대신에 나의 userseq !!!!!!!!!! -->
	...
	<div class="prdFooter">
		<c:if test="${pdDetail.nickname eq '쯩'}">
			<div class="list">
				<input type="button" value="목록" onclick="location.href='home.bill'" >
			</div>
			<div class="prdRev">
