...
<title>쪽지보내기</title>
	<style>
	.item1 { height: 500px; width: 500px; float: center;}
...
<body>	
	...
	<div class="item1">
		<form action="messageWin.bill" method="post" align = "center">
			<div width="500px" align="left">받는 사람 : <input type="text" name="nickname" value=<%= request.getParameter("nickname") %> readonly="readonly"></div>
