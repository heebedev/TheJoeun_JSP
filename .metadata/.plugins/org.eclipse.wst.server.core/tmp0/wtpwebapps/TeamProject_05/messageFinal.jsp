...
<title>쪽지 보관함</title>
	<script type="text/JavaScript">
         ...
         function msgDetail(nickname_send, nickname_receive, message, insertdate) { 
		...
		<div class="grid-container">
		  ...
		  <div class="item2">
				<c:forEach items="${messageList }" var="message">
					<div class="messageTable" onClick = "msgDetail('${message.nickname_send}', '${message.nickname_receive}', '${message.message}', '${message.date}')">
